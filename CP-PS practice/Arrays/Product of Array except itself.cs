...
/*One approach can be - Store the product of all the elements is variable and then iterate the array and add product/current_index_value in a new array. and then return this new array*/
